...
def plot_membership_functions():
    ...
    print("âœ“ Saved: FUZZY/plots/01_comparison_membership_functions.png")
    plt.close()
...
def create_comparative_plot():
    ...
    print("âœ“ Saved: FUZZY/plots/02_comparison_bar_charts.png")
    plt.close()
...
if __name__ == '__main__':
    ...
    print("\nThis will generate 8 PSO_FCS configurations (4 sets x 2 label counts)")
    print("="*130 + "\n")
